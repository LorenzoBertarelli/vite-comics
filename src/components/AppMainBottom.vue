<script>
import AppStyleCard from './AppStyleCard.vue';
...
<template>
    <main class="jumbo-bottom">
        <div class="container">
            <h1>Current Series</h1>

            <div class="row">
                <AppStyleCard v-for="(card,index) in imageCard" :key="index" :image="card.thumb" :title="card.series"/>
            </div>
